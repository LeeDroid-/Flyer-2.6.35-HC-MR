/* linux/arch/arm/mach-msm/board-flyer-wifi.c
 *
...
int flyer_wifi_set_carddetect(int on);
...
static void *flyer_wifi_mem_prealloc(int section, unsigned long size)
{
...
int __init flyer_init_wifi_mem(void)
{
	int i;
...
static struct resource flyer_wifi_resources[] = {
	[0] = {
...
static struct wifi_platform_data flyer_wifi_control = {
	.set_power      = flyer_wifi_power,
...
static struct platform_device flyer_wifi_device = {
        .name           = "bcm4329_wlan",
        .id             = 1,
        .num_resources  = ARRAY_SIZE(flyer_wifi_resources),
        .resource       = flyer_wifi_resources,
        .dev            = {
                .platform_data = &flyer_wifi_control,
        },
};

extern unsigned char *get_wifi_nvs_ram(void);

static unsigned flyer_wifi_update_nvs(char *str)
{
