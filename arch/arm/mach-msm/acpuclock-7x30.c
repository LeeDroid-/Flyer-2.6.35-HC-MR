...
#ifdef CONFIG_NUTTER
#define FLYER_ACPU_MAX_UV_MV 1550U
#else
...
//	{ 245000, PLL_3,    5, 2,  122500, 950, VDD_RAW(950) },
	{ 122000, PLL_3,    5, 2, 61440, 950, VDD_RAW(950) },
	{ 230400, PLL_3,    5, 1, 192000, 1000, VDD_RAW(1000) },
	{ 307200, PLL_3,    5, 1, 192000, 1025, VDD_RAW(1025) },
	{ 384000, PLL_1,    2, 0, 192000, 1050, VDD_RAW(1050) },
	{ 460800, PLL_3,    5, 1, 192000, 1075, VDD_RAW(1075) },
	{ 537600, PLL_2,    3, 0, 192000, 1075, VDD_RAW(1075) },
	{ 614400, PLL_2,    3, 0, 192000, 1100, VDD_RAW(1100) },
	{ 691200, PLL_2,    3, 0, 192000, 1100, VDD_RAW(1100) },
	{ 768000, PLL_2,    3, 0, 192000, 1125, VDD_RAW(1125) },
	{ 844800, PLL_2,    3, 0, 192000, 1150, VDD_RAW(1150) },
	{ 921600, PLL_2,    3, 0, 192000, 1150, VDD_RAW(1150) },
	{ 998400, PLL_2,    3, 0, 192000, 1150, VDD_RAW(1150) },
	{ 1075200, PLL_2,   3, 0, 192000, 1175, VDD_RAW(1175) },
	{ 1152000, PLL_2,   3, 0, 192000, 1200, VDD_RAW(1200) },
	{ 1228800, PLL_2,   3, 0, 192000, 1225, VDD_RAW(1225) },
	{ 1305600, PLL_2,   3, 0, 192000, 1275, VDD_RAW(1275) },
	{ 1382400, PLL_2,   3, 0, 192000, 1300, VDD_RAW(1300) },
	{ 1459200, PLL_2,   3, 0, 192000, 1325, VDD_RAW(1325) },
	{ 1536000, PLL_2,   3, 0, 192000, 1350, VDD_RAW(1350) },
#ifdef CONFIG_NUTTER	
	{ 1612800, PLL_2,   3, 0, 192000, 1400, VDD_RAW(1400) },
	{ 1689600, PLL_2,   3, 0, 192000, 1425, VDD_RAW(1425) },
	{ 1766400, PLL_2,   3, 0, 192000, 1450, VDD_RAW(1450) },
	{ 1843200, PLL_2,   3, 0, 192000, 1475, VDD_RAW(1475) },
	{ 1920000, PLL_2,   3, 0, 199680, 1500, VDD_RAW(1500) },
	{ 1996800, PLL_2,   3, 0, 199680, 1500, VDD_RAW(1525) },
#endif //CONFIG_NUTTER
	{ 0 }
};
...
static unsigned int acpuclk_get_current_vdd(void)
{
	...
	for (vdd_mv = FLYER_ACPU_MIN_UV_MV; vdd_mv <= FLYER_ACPU_MAX_UV_MV; vdd_mv += V_STEP)
		if (VDD_RAW(vdd_mv) == vdd_raw)
			break;

	if (vdd_mv > FLYER_ACPU_MAX_UV_MV)
		return 0;
...
static int acpuclk_update_freq_tbl(unsigned int acpu_khz, unsigned int acpu_vdd)
{
	...
	if (acpu_vdd > FLYER_ACPU_MAX_UV_MV || acpu_vdd < FLYER_ACPU_MIN_UV_MV) {
...
void acpuclk_set_vdd(unsigned int khz, int vdd)
{
	...
	{
		if (khz == 0)
			new_vdd = min(max((acpu_freq_tbl[i].vdd_mv + vdd), FLYER_ACPU_MIN_UV_MV), FLYER_ACPU_MAX_UV_MV);
		else if (acpu_freq_tbl[i].acpu_clk_khz == khz)
			new_vdd = min(max((unsigned int)vdd, FLYER_ACPU_MIN_UV_MV), FLYER_ACPU_MAX_UV_MV);
		else continue;
